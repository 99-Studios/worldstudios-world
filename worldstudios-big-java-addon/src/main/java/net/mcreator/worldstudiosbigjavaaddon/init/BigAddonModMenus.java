...
import net.mcreator.worldstudiosbigjavaaddon.network.MenuStateUpdateMessage;
import net.mcreator.worldstudiosbigjavaaddon.BigAddonMod;

import java.util.Map;

public class BigAddonModMenus {
	public static final DeferredRegister<MenuType<?>> REGISTRY = DeferredRegister.create(Registries.MENU, BigAddonMod.MODID);
	...
	public interface MenuAccessor {
		...
		default void sendMenuStateUpdate(Player player, int elementType, String name, Object elementState, boolean needClientUpdate) {
			...
			if (player instanceof ServerPlayer serverPlayer) {
				...
				if (Minecraft.getInstance().screen instanceof BigAddonModScreens.ScreenAccessor accessor && needClientUpdate)

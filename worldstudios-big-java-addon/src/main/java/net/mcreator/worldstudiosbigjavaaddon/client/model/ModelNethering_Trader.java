...
public class ModelNethering_Trader extends EntityModel<LivingEntityRenderState> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("big_addon", "model_nethering_trader"), "main");
	...
	public ModelNethering_Trader(ModelPart root) {
		super(root);
	...
	public void setupAnim(LivingEntityRenderState state) {
		...
		this.nose.xRot = netHeadYaw / (180F / (float) Math.PI);
		this.headwear.xRot = netHeadYaw / (180F / (float) Math.PI);

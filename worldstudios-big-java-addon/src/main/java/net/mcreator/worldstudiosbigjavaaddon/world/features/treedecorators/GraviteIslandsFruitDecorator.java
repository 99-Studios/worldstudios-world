...
@EventBusSubscriber
public class GraviteIslandsFruitDecorator extends CocoaDecorator {
	public static MapCodec<GraviteIslandsFruitDecorator> CODEC = MapCodec.unit(GraviteIslandsFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("big_addon:gravite_islands_tree_fruit_decorator"), () -> DECORATOR_TYPE);
	}

	public GraviteIslandsFruitDecorator() {
		super(0.2f);
	}

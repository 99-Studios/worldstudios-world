package net.mcreator.worldstudiosbigjavaaddon.world.features.treedecorators;
...
@EventBusSubscriber
public class GraviteIslandsLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<GraviteIslandsLeaveDecorator> CODEC = MapCodec.unit(GraviteIslandsLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("big_addon:gravite_islands_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public GraviteIslandsLeaveDecorator() {
		super(0.25f);
	}

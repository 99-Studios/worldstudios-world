...
@EventBusSubscriber
public class GraviteIslandsTrunkDecorator extends TrunkVineDecorator {
	public static MapCodec<GraviteIslandsTrunkDecorator> CODEC = MapCodec.unit(GraviteIslandsTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("big_addon:gravite_islands_tree_trunk_decorator"), () -> DECORATOR_TYPE);
	}

...
public class DinamiteProcedureProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
			...
			return;
		{
			...
			if (!projectileLevel.isClientSide()) {
				Projectile _entityToSpawn = initArrowProjectile(new DinamiteProjectileEntity(BigAddonModEntities.DINAMITE_PROJECTILE.get(), 0, 0, 0, projectileLevel, createArrowWeaponItemStack(projectileLevel, 1, (byte) 0)), entity,

...
public class TopTierChallengesProcedureProcedure {
	public static void execute(Entity entity) {
		...
		if (entity instanceof ServerPlayer _plr0 && _plr0.level() instanceof ServerLevel _serverLevel0
			...
			if (entity instanceof ServerPlayer _player && _player.level() instanceof ServerLevel _level) {
				AdvancementHolder _adv = _level.getServer().getAdvancements().get(ResourceLocation.parse("big_addon:top_tier_challenges"));
				if (_adv != null) {

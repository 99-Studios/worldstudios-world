...
public class LongZombieEntity extends Zombie {
	public LongZombieEntity(EntityType<LongZombieEntity> type, Level world) {
		super(type, world);
		xpReward = 16;
		setNoAi(false);
	}
	...
	public SoundEvent getAmbientSound() {
		return BuiltInRegistries.SOUND_EVENT.getValue(ResourceLocation.parse("entity.zombie_horse.ambient"));
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(BigAddonModEntities.LONG_ZOMBIE.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,

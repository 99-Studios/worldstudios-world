...
public class SugarEntityEntity extends Monster {
	public SugarEntityEntity(EntityType<SugarEntityEntity> type, Level world) {
		super(type, world);
		xpReward = 10;
		setNoAi(false);
	}
	...
	protected void dropCustomDeathLoot(ServerLevel serverLevel, DamageSource source, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(serverLevel, new ItemStack(BigAddonModItems.FERTILIZED_SUGAR.get()));
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(BigAddonModEntities.SUGAR_ENTITY.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,

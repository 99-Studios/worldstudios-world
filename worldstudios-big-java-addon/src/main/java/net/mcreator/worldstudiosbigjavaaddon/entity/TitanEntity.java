...
public class TitanEntity extends Zombie {
	public TitanEntity(EntityType<TitanEntity> type, Level world) {
		super(type, world);
		xpReward = 100;
		setNoAi(false);
	}
	...
	protected void dropCustomDeathLoot(ServerLevel serverLevel, DamageSource source, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(serverLevel, new ItemStack(BigAddonModItems.TITAN_HEART.get()));
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(BigAddonModEntities.TITAN.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,

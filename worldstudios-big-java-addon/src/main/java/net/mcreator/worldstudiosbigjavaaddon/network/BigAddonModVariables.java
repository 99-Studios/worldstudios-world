package net.mcreator.worldstudiosbigjavaaddon.network;
...
@EventBusSubscriber
public class BigAddonModVariables {
	public static final DeferredRegister<AttachmentType<?>> ATTACHMENT_TYPES = DeferredRegister.create(NeoForgeRegistries.Keys.ATTACHMENT_TYPES, BigAddonMod.MODID);

	@SubscribeEvent
	public static void init(FMLCommonSetupEvent event) {
		BigAddonMod.addNetworkMessage(SavedDataSyncMessage.TYPE, SavedDataSyncMessage.STREAM_CODEC, SavedDataSyncMessage::handleData);
	}
	...
	public static class WorldVariables extends SavedData {
		public static final SavedDataType<WorldVariables> TYPE = new SavedDataType<>("big_addon_worldvars", ctx -> new WorldVariables(), ctx -> CompoundTag.CODEC.xmap(tag -> {
	...
	public static class MapVariables extends SavedData {
		public static final SavedDataType<MapVariables> TYPE = new SavedDataType<>("big_addon_mapvars", ctx -> new MapVariables(), ctx -> CompoundTag.CODEC.xmap(tag -> {
		...
		public void read(CompoundTag nbt, HolderLookup.Provider lookupProvider) {
			ReboundedFireVariable = nbt.getBooleanOr("ReboundedFireVariable", false);
		}

		public CompoundTag save(CompoundTag nbt, HolderLookup.Provider lookupProvider) {
			nbt.putBoolean("ReboundedFireVariable", ReboundedFireVariable);
			return nbt;
		}
	...
	public record SavedDataSyncMessage(int dataType, SavedData data) implements CustomPacketPayload {
		public static final Type<SavedDataSyncMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(BigAddonMod.MODID, "saved_data_sync"));
